...
#define RFID_SIZE_AUTO_SCAN       8
#define RFID_SIZE_STOP_SCAN        6
#define RFID_SIZE_WRITE_DATA       25
#define RFID_SIZE_READ_DATA       18
#define RFID_SIZE_READ_EPCID       18
#define RFID_SIZE_READ_DEVICEID       6
