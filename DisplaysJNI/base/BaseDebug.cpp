...
wmSTRSTRING DwmGetName(wmCCHAR* full_name)
{
    wmSTRSTRING file_name = full_name;
    wmCCHAR*  mn_first = full_name;
    wmCCHAR*  mn_last  = full_name + strlen( full_name );
    if ( strrchr( full_name, '.' ) != wmNULL)
